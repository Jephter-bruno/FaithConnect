...
import com.glamour.faithconnect.live.activities.GoAudienceActivity;
...
public class AdapterLive extends RecyclerView.Adapter<AdapterLive.MyHolder>{
    ...
    int channelProfile;
    public static final String channelMessage = "com.glamour.faithconnect.CHANNEL";
    public static final String profileMessage = "com.glamour.faithconnect.PROFILE";
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(context).inflate(R.layout.live_list, parent, false);
