...
import com.glamour.faithconnect.watchParty.InviteActivity;
import com.glamour.faithconnect.watchParty.InviteMoreActivity;
...
public class AdapterUsersInviteMore extends RecyclerView.Adapter<AdapterUsersInviteMore.MyHolder>{
    ...
    public AdapterUsersInviteMore(Context context, List<ModelUser> userList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            hashMap.put("timestamp", InviteMoreActivity.getId());
