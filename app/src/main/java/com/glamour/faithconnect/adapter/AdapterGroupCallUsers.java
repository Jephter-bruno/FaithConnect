...
public class AdapterGroupCallUsers extends RecyclerView.Adapter<AdapterGroupCallUsers.MyHolder>{

    final Context context;
    final List<ModelUser> userList;

    @SuppressWarnings("unused")
    public AdapterGroupCallUsers(Context context, List<ModelUser> userList) {
