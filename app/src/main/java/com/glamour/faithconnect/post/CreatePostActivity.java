package com.glamour.faithconnect.post;
...
public class CreatePostActivity extends AppCompatActivity implements PrivacyPick.SingleChoiceListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (snapshot.exists()){
                    for (DataSnapshot ds : snapshot.getChildren()){
                        if (ds.child("type").getValue().toString().equals("calling")){
                            Intent intent = new Intent(CreatePostActivity.this, RingingActivity.class);
        ...
        if(getIntent().hasExtra("uri") && getIntent().hasExtra("type")){
            if(getIntent().getStringExtra("type").equals("video")){
                type = "video";
                video_uri = Uri.parse(getIntent().getStringExtra("uri"));
                ...
                cancel.setVisibility(View.VISIBLE);
                Picasso.get().load(Uri.parse(getIntent().getStringExtra("uri"))).into(imageView);
            }
        }
        ...
        if (getIntent().hasExtra("gif")){
            ...
            imageView.setVisibility(View.VISIBLE);
            cancel.setVisibility(View.VISIBLE);
            Glide.with(CreatePostActivity.this).load(getIntent().getStringExtra("gif")).thumbnail(0.1f).into(imageView);
        }
    ...
    private void compressVideo() {
        ...
        new CreatePostActivity.CompressVideo().execute("false",video_uri.toString(),file.getPath());
    }
    ...
    private void addPost() {
        if (post_more == null){
            ...
            view.findViewById(R.id.stories).setOnClickListener(v -> {
                Intent i = new Intent(CreatePostActivity.this, AddStoryActivity.class);
                startActivity(i);
            });
  ...
  public void onNegativeButtonClicked() {
    ...
    public void onClick(View v) {
        ...
        /*    case R.id.meeting:
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){
                            ...
                            Intent i = new Intent(CreatePostActivity.this, GoBroadcastActivity.class);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()){
                            if (ds.child("from").getValue().toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                                ...
                                startActivity(new Intent(CreatePostActivity.this, StartWatchPartyActivity.class));
                            }else {
                                startActivity(new Intent(CreatePostActivity.this, StartWatchPartyActivity.class));
                            }
                        }
            ...
            case R.id.sell:
                post_more.cancel();
                startActivity(new Intent(CreatePostActivity.this, PostProductActivity.class));
                break;
            case R.id.camera:
                post_more.cancel();
                startActivity(new Intent(CreatePostActivity.this, FaceFilters.class));
                break;
            case  R.id.gif:
               ...
               Intent intent = new Intent(CreatePostActivity.this, StickersPost.class);
    ...
    private void createPod() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    snapshot.getRef().removeValue();
                    Intent i = new Intent(CreatePostActivity.this, GoPodcastBroadcastActivity.class);
                    i.putExtra("name", room);
                    i.putExtra("type", "host");
                    startActivity(i);
                }else {
