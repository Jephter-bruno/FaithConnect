package com.glamour.faithconnect.live.activities;
...
public class GoBroadcastActivity extends BaseActivity {
    ...
    public void gotoRoleActivity() {
        ...
        reference.child(room).setValue(hashMap).addOnCompleteListener(task -> {
            ...
            Intent intent = new Intent(GoBroadcastActivity.this, BroadcasterActivity.class);
