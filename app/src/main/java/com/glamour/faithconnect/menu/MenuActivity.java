package com.glamour.faithconnect.menu;
...
import com.glamour.faithconnect.SharedMode;
import com.glamour.faithconnect.live.activities.GoBroadcastActivity;
import com.glamour.faithconnect.marketPlace.MarketPlaceActivity;
...
import com.glamour.faithconnect.search.LocationActivity;
import com.glamour.faithconnect.search.SearchActivity;
import com.glamour.faithconnect.send.ImageEditingActivity;
import com.glamour.faithconnect.send.VideoEditingActivity;
import com.glamour.faithconnect.watchParty.StartWatchPartyActivity;
import com.glamour.faithconnect.welcome.IntroLast;
        ...
        FirebaseDatabase.getInstance().getReference("Admin").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    findViewById(R.id.admin).setVisibility(View.GONE); // CHnage this to GONE
                }
            }
