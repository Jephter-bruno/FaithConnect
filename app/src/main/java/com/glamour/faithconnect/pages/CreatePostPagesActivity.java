...
import com.glamour.faithconnect.watchParty.StartWatchPartyActivity;
...
public class CreatePostPagesActivity extends AppCompatActivity implements PrivacyPick.SingleChoiceListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_post_pages);
            ...
            if (type.equals("bg")){
                ...
                if (Objects.requireNonNull(bg_text.getText()).toString().isEmpty()){
                    ...
                    if (number.equals("upload")){
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Pages").child(groupID).child("Posts").child(timeStamp).setValue(hashMap);
        ...
        if (getIntent().hasExtra("gif")){
            ...
            Glide.with(CreatePostPagesActivity.this).load(getIntent().getStringExtra("gif")).thumbnail(0.1f).into(imageView);
        }
    ...
    private class CompressVideo extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                videoPath = SiliCompressor.with(CreatePostPagesActivity.this)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK && requestCode == REEl_PICK_CODE && data != null){
            ...
            if (timeInMilli > 10000){
                ...
                Intent intent = new Intent(CreatePostPagesActivity.this, VideoEditActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){
                            ...
                            Intent i = new Intent(CreatePostPagesActivity.this, GoBroadcastActivity.class);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()){
                            if (ds.child("from").getValue().toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                                ...
                                startActivity(new Intent(CreatePostPagesActivity.this, StartWatchPartyActivity.class));
                            }else {
                                startActivity(new Intent(CreatePostPagesActivity.this, StartWatchPartyActivity.class));
                            }
                        }
            ...
            case R.id.sell:
                post_more.cancel();
                startActivity(new Intent(CreatePostPagesActivity.this, PostProductActivity.class));
                break;
            case R.id.camera:
                post_more.cancel();
                startActivity(new Intent(CreatePostPagesActivity.this, FaceFilters.class));
                break;
            case  R.id.gif:
                ...
                Intent intent = new Intent(CreatePostPagesActivity.this, StickersPost.class);
                intent.putExtra("activity", "pages");
                startActivity(intent);
