package com.glamour.faithconnect.groupVideoCall.propeller;
...
public class Constant {
    ...
    public static final boolean SHOW_VIDEO_INFO = true;

    public static boolean DEBUG_INFO_ENABLED = true; // Show debug/log info on screen

    public static final boolean BEAUTY_EFFECT_ENABLED = true; // Built-in face beautification
