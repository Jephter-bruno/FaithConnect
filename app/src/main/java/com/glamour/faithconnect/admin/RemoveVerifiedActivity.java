...
import com.glamour.faithconnect.adapter.AdapterVerificationAlready;
...
public class RemoveVerifiedActivity extends AppCompatActivity {

    private RecyclerView users_rv;
    private List<ModelUser> userList;
    private AdapterVerificationAlready adapterUsers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users_rv.setLayoutManager(new LinearLayoutManager(RemoveVerifiedActivity.this));
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot ds: snapshot.getChildren()){
                            ...
                            if (modelUser.getVerified().equals("yes")){
                                userList.add(modelUser);
                            }
                        }
                        adapterUsers = new AdapterVerificationAlready(RemoveVerifiedActivity.this, userList);
