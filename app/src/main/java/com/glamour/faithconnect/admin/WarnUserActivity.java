...
import com.glamour.faithconnect.adapter.AdapterWarnUsers;
...
public class WarnUserActivity extends AppCompatActivity {
    ...
    private AdapterWarnUsers adapterUsers;
        ...
        FirebaseDatabase.getInstance().getReference("Users")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapterUsers = new AdapterWarnUsers(WarnUserActivity.this, userList);
