...
import com.glamour.faithconnect.adapter.AdapterDeleteUsers;
...
public class DeleteUserActivity extends AppCompatActivity {
    ...
    private AdapterDeleteUsers adapterUsers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users_rv.setLayoutManager(new LinearLayoutManager(DeleteUserActivity.this));
        ...
        FirebaseDatabase.getInstance().getReference("Users")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapterUsers = new AdapterDeleteUsers(DeleteUserActivity.this, userList);
