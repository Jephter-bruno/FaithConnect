...
import com.glamour.faithconnect.adapter.AdapterReportGroups;
...
public class ReportedGroupsActivity extends AppCompatActivity {

    private RecyclerView users_rv;
    private List<ModelGroups> userList;
    private AdapterReportGroups adapterUsers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users_rv.setLayoutManager(new LinearLayoutManager(ReportedGroupsActivity.this));
        userList = new ArrayList<>();
        followingList = new ArrayList<>();
        FirebaseDatabase.getInstance().getReference("GroupsReport").addValueEventListener(new ValueEventListener() {
            @Override
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot ds: snapshot.getChildren()){
                            ...
                            for (String id : followingList){
                                if (Objects.requireNonNull(modelUser).getGroupId().equals(id)){
                                    userList.add(modelUser);
                                }
                            }
                        }
                        adapterUsers = new AdapterReportGroups(ReportedGroupsActivity.this, userList);
