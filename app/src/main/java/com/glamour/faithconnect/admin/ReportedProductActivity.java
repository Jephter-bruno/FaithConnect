...
import com.glamour.faithconnect.adapter.AdapterProductReport;
...
public class ReportedProductActivity extends AppCompatActivity {

    private RecyclerView users_rv;
    private List<ModelProduct> userList;
    private AdapterProductReport adapterUsers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users_rv.setLayoutManager(new LinearLayoutManager(ReportedProductActivity.this));
        userList = new ArrayList<>();
        followingList = new ArrayList<>();
        FirebaseDatabase.getInstance().getReference("ReportProduct").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        FirebaseDatabase.getInstance().getReference("Product")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapterUsers = new AdapterProductReport(ReportedProductActivity.this, userList);
