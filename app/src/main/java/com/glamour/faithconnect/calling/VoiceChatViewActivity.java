package com.glamour.faithconnect.calling;
        ...
        FirebaseDatabase.getInstance().getReference().child("calling").child(room).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (type.equals("end")){
                    ...
                    //Type
                    String id = snapshot.child("to").getValue().toString();
                    if (id.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                        intent.putExtra("hisUID", snapshot.child("from").getValue().toString());
                    }else {
                        intent.putExtra("hisUID", snapshot.child("to").getValue().toString());
                    }
                ...
                String id = snapshot.child("to").getValue().toString();
                if (id.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                    hisId = snapshot.child("from").getValue().toString();
                }else {
                    hisId = snapshot.child("to").getValue().toString();
                }
